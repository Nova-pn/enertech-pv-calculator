...
const fonctionnalites = [
  ...
  { titre: 'Dimensionnement solaire', desc: 'Puissance PV nécessaire à partir de vos heures solaires de pointe et du rendement système.' },
  { titre: 'Batterie', desc: "Capacité en Ah et configuration série/parallèle selon l'autonomie souhaitée." },
  { titre: 'Onduleur', desc: 'Puissance minimale recommandée, avec alerte sur les charges à démarrage important.' },
  { titre: 'Régulateur MPPT', desc: 'Courant recommandé et vérification du calibre choisi.' },
  { titre: 'Configuration PV', desc: 'Test des combinaisons série/parallèle contre les limites de votre onduleur ou régulateur.' },
